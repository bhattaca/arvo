...
def batch_inputs(data_files, batch_size, image_size, train, num_epochs, num_preprocess_threads):
    ...
    with tf.name_scope('batch_processing'):
        ...
        print ( 'fileName size ', filename_queue.size)
        ...
        print  ( 'color image size ', color_image.shape)
        print  ( 'label image size ', label_image.shape)
        ...
        if train:
            ...
            print ( 'images for train : ', images.shape)
            print ( 'labels for train : ', labels.shape)
        else:
